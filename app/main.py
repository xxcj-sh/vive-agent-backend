...
from app.routers import user_card, users, matches, auth, membership, membership_orders, scenes, file, properties, llm, subscribe_message, activity_invitation, chats, topic_cards
...
# 活动邀约路由
app.include_router(activity_invitation.router, prefix="/api/v1/activity-invitations")
app.include_router(chats.router, prefix="/api/v1")

# AI技能路由
app.include_router(ai_skills_router, prefix="/api/v1/ai-skills")
